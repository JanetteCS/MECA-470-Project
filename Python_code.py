...
err_code,j1 = sim.simxGetObjectHandle(clientID,"L2",sim.simx_opmode_blocking)
err_code,j2 = sim.simxGetObjectHandle(clientID,"L1",sim.simx_opmode_blocking)
err_code,j3 = sim.simxGetObjectHandle(clientID,"L3",sim.simx_opmode_blocking)
err_code,j4 = sim.simxGetObjectHandle(clientID,"L4",sim.simx_opmode_blocking)
...
def turn(upper_pos):
    ...
    err_code = sim.simxSetJointTargetPosition (clientID, j2,upper_pos,sim.simx_opmode_streaming) # set the postion of J1

    err_code = sim.simxSetJointTargetPosition (clientID, j1,(upper_pos),sim.simx_opmode_streaming) # set the postion of J2
